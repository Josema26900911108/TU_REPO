...
public function DesingDocument(){
    ...
    protected $fillable = ['idTienda','Nombre', 'Direccion', 'Telefono', 'descripcion', 'EstatusContable','fkCentro','logo', 'departamento','municipio','representante','nit','fkDesignDocument','firma_representante']; // Agrega aquí todos los campos que deseas que sean "fillables"
