...
class Arbolmateriales extends Model implements TreeConfigurable
{

    use NestedSetTrait;

    protected $table = 'arbolmaterial'; // Cambia 'tienda' por el nombre correcto de tu tabla
    protected $primaryKey = 'id'; // Especifica la clave primaria

    public $incrementing = true; // Si es autoincremental
    protected $keyType = 'int'; // Para BIGINT(20)

    protected $fillable = ['id','fkTienda','nombre','SKU','Tipo_servicio','Tipo_orden','aplicafotografia','obs','padre_id','created_at','updated_at'];
