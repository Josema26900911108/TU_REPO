...
// ============================================================================
// RUTAS: CENTROS (CONFIGURACIÓN REPARADA)
// ============================================================================
Route::post('centrosstore', [centroController::class, 'store'])->name('centros.store_alterno');

// Devolvemos los nombres originales exactos que requiere tu sistema:
...
// ============================================================================
// RUTAS: CENTROS ORGANIZACIÓN (REPARADO)
// ============================================================================
...
// Devolvemos el nombre exacto que te acaba de solicitar el error:
...
Route::post('/expediente/guardar-foto-flotante', [TecnicoController::class, 'guardarFotografiaAjax'])
