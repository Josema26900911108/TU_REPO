...
return new class extends Migration
{
    ...
    {
        // 1. Apagamos las revisiones estrictas para poder limpiar
        DB::statement('SET FOREIGN_KEY_CHECKS=0;');

        // 2. BORRAR LA TABLA HUÉRFANA SI SE QUEDÓ A MEDIAS DEL INTENTO PREVIO
        ...
        // 4. Enlazar foráneamente a idTienda de forma nativa directa
