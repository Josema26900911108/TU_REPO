...
<title>babd8334-46d1-455b-a1e2-f65e3661dedf</title>
    ...
    <tr>
        ...
        <th>
            <table>
                <tr>
                    <td>
                        <p style="text-indent: 0pt;text-align: left; margin-top: 50px; padding-left: 35px;"><img width="151" height="86" src="[TU_IMAGEN_AQUÍ]" alt="Logo"/></p>
                    </td>
                    <td>
                        ...
                        <p style="padding-top: 1pt;padding-center: 133pt;text-indent: 0pt;text-align: center;">NIT : 20578091</p><p style="padding-top: 1pt;padding-center: 133pt;text-indent: 0pt;line-height: 108%;text-align: center;">QUETZALTENANGO.</p>
                    </td>
                    <td>
            ...
            <table style="border-collapse:collapse;margin-left:5.91399pt" cellspacing="0">
                <tr style="height:15pt">
                    ...
                    <td style="width:257pt;border-top-style:solid;border-top-width:1pt"><p class="s4" style="padding-left: 2pt;text-indent: 0pt;line-height: 13pt;text-align: left;">Sanatorio San Pablo</p></td><td style="width:64pt;border-top-style:solid;border-top-width:1pt"><p class="s3" style="padding-left: 2pt;text-indent: 0pt;line-height: 13pt;text-align: left;">Fecha:</p></td>

                    <td style="width:106pt;border-top-style:solid;border-top-width:1pt;border-right-style:solid;border-right-width:1pt"><p class="s4" style="padding-left: 51pt;text-indent: 0pt;line-height: 13pt;text-align: left;">22/05/2025</p></td></tr>
                    ...
                    <tr style="height:421pt" >
                        <td style="width:64pt;border-top-style:solid;border-top-width:1pt;border-top-color:#1F4E78;border-left-style:solid;border-left-width:1pt;border-left-color:#1F4E78;border-bottom-style:solid;border-bottom-width:1pt;border-bottom-color:#1F4E78">

                        <td style="width:257pt;border-top-style:solid;border-top-width:1pt;border-top-color:#1F4E78;border-bottom-style:solid;border-bottom-width:1pt;border-bottom-color:#1F4E78">
                            <p style="text-indent: 0pt;text-align: left;">
                            <span>
                                <table border="0" cellspacing="0" cellpadding="0">
                                    <tr><td>
                                        <img width="422" height="308" src="[TU_IMAGEN_AQUÍ]" alt="Imagen de producto"/>
                                    </td></tr>
                                </table>
                            </span>
                            </p>
                        ...
                        <td style="width:106pt;border-bottom-style:solid;border-bottom-width:1pt;border-bottom-color:#1F4E78;border-right-style:solid;border-right-width:1pt">
