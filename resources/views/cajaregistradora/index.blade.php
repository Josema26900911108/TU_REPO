...
<div class="container-fluid px-4">
    ...
    <div class="mb-4">
        <a href="{{route('cajaregistradora.create')}}">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <table id="datatablesSimple" class="table table-striped fs-6">
                ...
                <tbody>
                    @foreach ($cajaregistradora as $item)
                    <tr>
                        <td>
                            {{$item->initial_amount}}
                        </td>
                        ...
                        <td>
                            ...
                            @else
                            <span class="badge rounded-pill text-bg-danger">Cerrado</span>
                            @endif
                        </td>
                        <td>
                            <div class="d-flex justify-content-around">
                                <div>
                                    ...
                                    <ul class="dropdown-menu text-bg-light" style="font-size: small;">
                                        ...
                                        <li><a class="dropdown-item" href="{{route('cajaregistradora.edit',['cash'=>$item])}}">Editar</a></li>
                                        @endcan
                                    </ul>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <button title="Eliminar" data-bs-toggle="modal" data-bs-target="#confirmModal-{{$item->id}}" class="btn btn-datatable btn-icon btn-transparent-dark">
                                        <svg class="fa-solid fa-cash-register" aria-hidden="true" focusable="false" data-prefix="far" data-icon="cash-register-can" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    {{ $item->closed_at == "" ? '¿Seguro que cerrar caja?' : '¿Esta Caja ya esta cerrada, deseas actualizar cierre?' }}
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
                                    <form action="{{ route('cajaregistradora.destroy',['cajaregistradora'=>$item->id]) }}" method="post">
                                        @method('DELETE')
                                        @csrf
