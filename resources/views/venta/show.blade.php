            ...
            <div class="row mb-4">
                ...
                <div class="col-sm-6">
                    <div class="input-group">
                        ...
                        <input disabled type="text" class="form-control" value="{{ $venta->comprobante->tipo_comprobante ?? 'Sin Comprobante' }}">
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-4">
                ...
                <div class="col-sm-6">
                    <div class="input-group">
                        ...
                        <input disabled type="text" class="form-control" value="{{$venta->numero_comprobante ?? 'Sin Comprobante' }}">
                    </div>
                </div>
            </div>
