...
<div class="container-fluid px-4">
    <h1 class="mt-4 text-center">Permiso</h1>
                            ...
                            <div class="d-flex justify-content-around">
                                ...
                                <div>
                                    ...
                                    <ul class="dropdown-menu text-bg-light" style="font-size: small;">
                                        <!-----Editar permiso--->
                                        @can('editar-permiso')
                                        <li><a class="dropdown-item" href="{{route('permiso.edit',['permiso'=>$item])}}">Editar</a></li>
                                        @endcan
                                    </ul>
                                </div>
                                <div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    {{ $item->name != ''
                                        ? '¿Seguro que quieres eliminar el permiso ' . $item->name . '?'
                                        : '¿Seguro que quieres restaurar el permiso ' . $item->name . '?'
                                    }}
                                </div>

                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
                                    <form action="{{ route('permiso.destroy',['permiso'=>$item->id]) }}" method="post">
                                        @method('DELETE')
                                        @csrf
