...
<div class="container-fluid px-4">
    <h1 class="mt-4 text-center">Tienda</h1>
        ...
        <div class="card-body">
            <table id="datatablesSimple" class="table table-striped fs-6">
                ...
                <tbody>
                            ...
                            <div class="d-flex justify-content-around">
                                ...
                                <div>
                                    ...
                                    <ul class="dropdown-menu text-bg-light" style="font-size: small;">
                                        <!-----Editar permiso--->
                                        @can('editar-tienda')
                                        <li><a class="dropdown-item" href="{{route('tienda.edit',['tienda'=>$item->idTienda])}}">Editar</a></li>

                                        <li><a class="dropdown-item" href="{{route('tienda.editfactura',['tienda'=>$item->idTienda])}}">Editar Factura</a></li>
                                        @endcan
                                    </ul>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <button title="Eliminar" data-bs-toggle="modal" data-bs-target="#confirmModal-{{$item->idTienda}}" class="btn btn-datatable btn-icon btn-transparent-dark">
                    ...
                    <!-- Modal -->
                    <div class="modal fade" id="confirmModal-{{$item->idTienda}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    {{ $item->name != ''
                                        ? '¿Seguro que quieres eliminar el tienda ' . $item->Nombre . '?'
                                        : '¿Seguro que quieres restaurar el tienda ' . $item->Nombre . '?'
                                    }}
                                </div>

                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
                                    <form action="{{ route('tienda.destroy',['tienda'=>$item->idTienda]) }}" method="post">
                                        @method('DELETE')
                                        @csrf
