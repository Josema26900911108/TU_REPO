    ...
    <div class="card mb-2">
        <div class="card-header">
            ...
            Tabla de detalle de la compra
                        ...
                        <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#confirmModalPDF-{{ $compra->id }}">Imprimir PDF
        ...
        <div class="card-body table-responsive">
            <table class="table table-striped">
                ...
                <tfoot>
                    ...
                    <div class="modal fade" id="confirmModalPDF-{{$compra->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <form action="{{ route('arqueocaja.vistapreviapdfcompra',['arqueocaja'=>$compra->id]) }}" method="post">

                                        <input type="hidden" name="idcaja" id="idcaja">

                                        <input type="hidden" name="idventa" value="{{ $compra->id }}">
                                        @csrf
