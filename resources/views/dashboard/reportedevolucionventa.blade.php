...
<div class="container">
    ...
    <h4 class="mb-3">Reporte de Devolucion en Ventas</h4>

    <form method="GET" action="{{ route('devvent.devolucionventasreporte') }}" class="row g-3 mb-4">
    ...
    <hr>
    <form method="GET" action="{{ route('Devexport.excel') }}" class="d-inline">
