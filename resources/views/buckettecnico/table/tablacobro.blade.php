...
<div class="row g-3 mb-4">
    ...
    <!-- Tarjeta 2: Cantidad de Servicios -->
    <div class="col-md-4">
...
<!-- Buscador y Contenedor Principal de la Tabla -->
        ...
        <table id="datatablesSimpleCobro" class="table table-hover align-middle mb-0 fs-12 text-secondary">
            ...
            <tbody>
                @if($relacion && $relacion->count() > 0)
                    ...
                    @endforeach
                @else
                    <!-- Fila alternativa con 9 celdas independientes para evitar error de conteo -->
                    <tr>
                        <td class="ps-3 py-5 text-muted bg-light-subtle"></td>
                        <td></td>
                        <td></td>
                        <td class="text-center text-muted fs-13 py-5" style="white-space: nowrap;">
            ...
            @if($relacion && $relacion->count() > 0)
                <tfoot class="table-light fw-bold border-top text-muted">
                    <tr>
                        ...
                        <td class="text-end text-danger">Q{{ number_format($relacion->sum('COSTOPAGO'), 2) }}</td>
                        <td></td>
                        <td class="pe-3"></td>
                    </tr>
                </footer>
