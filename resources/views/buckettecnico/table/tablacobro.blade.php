...
<div class="table-responsive">
    <table id="datatablesSimpleCobro" class="table table-hover align-middle mb-0 fs-12 text-secondary">
        ...
        @if($relacion->count() > 0)
            <!-- TFOOT ADAPTADO: 9 Columnas exactas mapeadas para la sección de cobros -->
            <tfoot class="table-light fw-bold border-top text-muted">
                <tr>
                    ...
                    <td class="text-end text-danger">Q{{ number_format($relacion->sum('COSTOPAGO'), 2) }}</td> <!-- 7. Cobro Dinero -->
                    <td></td>                     <!-- 8. Nat. -->
