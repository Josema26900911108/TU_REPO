...
<div id="tabla_pago_content">
    ...
    <!-- 🟢 ENVOLTORIO DE BOOTSTRAP PARA SCROLL HORIZONTAL AUTOMÁTICO -->
    <div class="table-responsive">
        <!-- Se agrega 'text-nowrap' para evitar saltos de línea molestos en las celdas -->
        <table id="datatablesSimpleAsig" class="table table-striped table-bordered fs-12 text-nowrap align-middle">
            <thead>
                <tr>
                    <th>Orden</th>
                    <th>Virtual</th>
                        ...
                        <div class="d-flex justify-content-around">
                            <div class="dropdown">
                                <button title="Opciones" class="btn btn-datatable btn-icon btn-transparent-dark me-2" data-bs-toggle="dropdown" aria-expanded="false">
                                    <svg class="svg-inline--fa fa-ellipsis-vertical" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="ellipsis-vertical" role="img" xmlns="http://w3.org" viewBox="0 0 128 512" style="width: 8px; height: 16px;">
    ...
    </div> <!-- 🟢 CIERRE DEL ENVOLTORIO RESPONSIVO -->
...
<!-- SCRIPT DE INTERACCIÓN CON EL MODAL -->
<script>
