        ...
        <table id="datatablesSimplePago" class="table table-hover align-middle mb-0 fs-12 text-secondary">
            ...
            <tbody>
                @if($relacion && $relacion->count() > 0)
                    ...
                    @endforeach
                @else
                    <!-- SOLUCIÓN DEFINITIVA: 9 celdas nativas individuales vacías sin usar atributos colspan -->
                    <tr>
