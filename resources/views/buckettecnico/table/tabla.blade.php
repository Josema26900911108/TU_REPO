<div class="card">
    ...
    <div class="card-body" style="overflow-x: auto;">
        <!-- TABLA LIMPIA: Sin modales interrumpiendo las filas -->
        <table id="datatablesSimpleAsig" class="table table-striped fs-12" style="min-width: 800px;">
            <thead>
                <tr>
                    <th>Orden</th>
                    <th>Virtual</th>
...
<!-- ========================================== -->
<!-- SECCIÓN DE MODALES (FUERA DE LA CARD Y TABLA) -->
<!-- ========================================== -->
@foreach ($relacion as $item)
    <!-- Modal Detalles -->
