...
@section('title','Inventario Warehouse')
...
@include('layouts.partials.alert')
    ...
    <div class="container-fluid px-4">
        ...
        <ol class="breadcrumb mb-4">
            ...
            <li class="breadcrumb-item active">Inventario Warehouse Movimiento de materiales entre organizaciones</li>
        </ol>
    </div>
...
<ul class="nav nav-tabs" id="tecnicoTabs" role="tablist">
    <li class="nav-item" role="presentation">
        <button class="nav-link active" id="datos-tab" data-bs-toggle="tab" data-bs-target="#datos" type="button" role="tab">
            Inventario Warehouse Movimiento de materiales entre organizaciones
        </button>
    </li>
    ...
    <div class="card-body">
        ...
        <div class="row align-items-center g-3 pb-3 mb-3 border-bottom">
            <div class="col-12 col-md-8">
                <form action="{{ route('movimientomateriales.importar') }}" method="POST" enctype="multipart/form-data" class="d-flex align-items-center gap-2 flex-wrap">
                    @csrf
            ...
            <div class="col-12 col-md-4 text-md-end">
                <a href="{{route('movimientomateriales.formeta')}}" class="btn btn-outline-secondary w-100 w-md-auto">
        ...
        <div class="row g-4">
            ...
            <div class="col-12 col-lg-8 border-end">
                ...
                <form action="{{ route('movimientomateriales.AutomataValidarMamo') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row g-3">
            ...
            <div class="col-12 col-lg-4 d-flex flex-column justify-content-between">
                <div>
                    ...
                    <form action="{{ route('movimientomateriales.AutomataValidarMamoOrden') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
    ...
    buttons: [
        {
            ...
            action: function (e, dt, node, config) {
                ...
                var exportUrl = "{{ route('exportar.movimientomateriales.excel') }}?" + $.param({
                    id: id,
                    fechain: fechain,
                    fechafin: fechafin,
                    search: search
...
function fillRelacionAsignada(page = 1) {
    ...
    $.ajax({
        url: "{{ route('fetchrelacionmovimientomateriales') }}",
        method: 'GET',
