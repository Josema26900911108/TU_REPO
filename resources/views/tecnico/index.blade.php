...
<div class="container-fluid px-4">
    <h1 class="mt-4 text-center">Tecnicos</h1>
    ...
    <div class="mb-4">
        <a href="{{route('tecnico.create')}}">
            <button type="button" class="btn btn-primary">Añadir nuevo tecnico</button>
        </a>
    </div>
    @endcan
                            ...
                            <div class="d-flex justify-content-around">
                                <div>
                                    ...
                                    <ul class="dropdown-menu text-bg-light" style="font-size: small;">
                                        <!-----Editar usuarios--->
                                        @can('editar-tecnico')
                                        <li><a class="dropdown-item" href="{{ route('tecnico.edit', ['user' => $item['id']]) }}">Editar</a></li>
                                        @endcan

                                        @can('buckets-tecnicos')
                                        <li><a class="dropdown-item" href="{{ route('tecnico.bucket', ['usbucket' => $item['id']]) }}">Bucket Tecnico</a></li>
                                        @endcan

                                        @can('ver-pagocobrotecnico')
                                        <li><a class="dropdown-item" href="{{ route('tecnico.pagocobro', ['user' => $item['id']]) }}">Pago/Cobro a Tecnico</a></li>
                                        @endcan

                                        @can('ver-pagotecnico')
                                        <li><a class="dropdown-item" href="{{ route('tecnico.produccion', ['user' => $item['id']]) }}">Producion de Tecnico</a></li>
                                        @endcan
                                    </ul>
                                </div>
                                <div>
