...
$(document).ready(function () {
    ...
    if (email.length > 0) {
        // Realizar la llamada AJAX con método POST
        $.ajax({
            url: '/tiendas', // Cambia a la ruta del controlador
            method: 'POST',
            data: {
                email: email // Enviar el email directamente
            },
            success: function (data) {
                ...
                if (data.length === 0) {
                    ...
                    $.each(data, function (index, tienda) {
                        $('#idTienda').append(new Option('Tienda ' + tienda.Nombre, tienda.idTienda));
                    });
                }
            },
            error: function (xhr) {
                console.error('Se ha encontrado el siguiente error: ', xhr);
            }
        });
    } else {
        $('#idTienda').empty();
                            ...
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="/login" method="post">
                                        ...
                                        <div class="form-floating mb-3">
                                            <select data-size="4" title="Seleccione una Usuario" data-live-search="true" name="idTienda" id="idTienda" class="form-control selectpicker show-tick"></select>
            ...
            <footer class="py-4 bg-light mt-auto">
                <div class="container-fluid px-4">
                    <div class="d-flex align-items-center justify-content-between small">
                        <div class="text-muted">Copyright &copy; Website 2022</div>
                        <div>
